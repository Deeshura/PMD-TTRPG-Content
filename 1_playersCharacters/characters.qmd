...
A bonus (or penalty) that is applied to some of a characters rolls based on the value of a their ability scores. The higher the ability score, the bigger the bonus (and inversely, the lower, the bigger the penalty).
...
: Table of Ability Scores and Modifiers {#tbl-scores}
...
::: {.callout-note .column-margin}
Many residents of the World of Pokemon own purely cosmetic personal possessions, like plain scarves or other visual accessories. Items that are purely cosmetic exist only in narration- it's not necessary to keep track of on your sheet.
:::
...
The currency of the World of Pokemon. Poke is generally shared amongst the team, like items, but you can also hold on to personal savings in case you don't have access to the team inventory. It can be noted in shorthand as a number followed by the letter 'p', for example, `100p` is short for 100 Poke.
